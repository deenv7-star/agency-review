...
'.dna-orb-log{flex:1;overflow:auto;padding:14px 16px;display:flex;flex-direction:column;gap:10px}'+
...
'.dna-orb-chips{display:flex;gap:6px;flex-wrap:wrap;padding:0 16px 12px}.dna-orb-chips button{font:inherit;font-size:13px;padding:7px 12px;border-radius:999px;border:1px solid rgba(255,255,255,.25);background:transparent;color:#fff;cursor:pointer}.dna-orb-chips button:hover{border-color:#dfff00;color:#dfff00}'+
